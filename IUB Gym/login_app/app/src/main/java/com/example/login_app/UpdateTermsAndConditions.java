...
public class UpdateTermsAndConditions extends AppCompatActivity {
    EditText terms;
    Button savebtn;
        ...
        savebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                databaseReference.child("conditions").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        String getTerms = snapshot.getValue(String.class);
                        Toast.makeText(UpdateTermsAndConditions.this, "Updated Successfully", Toast.LENGTH_SHORT).show();
                    }
